...
def launch_robot_server(args: Args):
    ...
    if args.robot == "sim_ur":
        ...
        if args.robot == "xarm":
            ...
            from gello.robots.piper import PiperROSRobot
            ...
            raise NotImplementedError(
                f"Robot {args.robot} not implemented, choose one of: sim_ur, xarm, ur, bimanual_ur, yam, piper, none"
            )
