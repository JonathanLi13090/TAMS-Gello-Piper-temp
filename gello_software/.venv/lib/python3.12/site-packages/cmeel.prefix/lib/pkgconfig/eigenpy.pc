...
Conflicts: 
Libs: -L${libdir}  -leigenpy
Libs.private: 
Cflags:  -I${includedir} -I/opt/python/cp312-cp312/include/python3.12 -I/tmp/pip-build-env-kp_i0vmb/overlay/lib/python3.12/site-packages/numpy/_core/include
