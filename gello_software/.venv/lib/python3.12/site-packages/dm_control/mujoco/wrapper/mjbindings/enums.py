...
mjrPixelFormat = collections.namedtuple(
    "mjrPixelFormat",
...
mjrVertexAttributeUsage = collections.namedtuple(
...
mjrVertexAttributeType = collections.namedtuple(
...
mjrIndexType = collections.namedtuple(
    "mjrIndexType",
    ["mjINDEX_TYPE_U16",
     "mjINDEX_TYPE_U32"]
)(0, 1)

mjrMeshPrimitiveType = collections.namedtuple(
...
mjtDisableBit = collections.namedtuple(
    ...
    ["mjDSBL_CONSTRAINT",
     ...
     "mjDSBL_MULTICCD",
     "mjNDISABLE"]
)(1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072, 262144, 524288, 20)
...
mjtProjection = collections.namedtuple(
    "mjtProjection",
    ["mjPROJ_PERSPECTIVE",
     "mjPROJ_ORTHOGRAPHIC"]
)(0, 1)
...
mjtConDataField = collections.namedtuple(
    "mjtConDataField",
    ["mjCONDATA_FOUND",
     "mjCONDATA_FORCE",
     "mjCONDATA_TORQUE",
...
mjtRayDataField = collections.namedtuple(
    "mjtRayDataField",
    ["mjRAYDATA_DIST",
     "mjRAYDATA_DIR",
     "mjRAYDATA_ORIGIN",
...
mjtCamOutBit = collections.namedtuple(
    "mjtCamOutBit",
    ["mjCAMOUT_RGB",
     "mjCAMOUT_DEPTH",
     "mjCAMOUT_DIST",
...
mjtSleepPolicy = collections.namedtuple(
    "mjtSleepPolicy",
    ["mjSLEEP_AUTO",
     "mjSLEEP_AUTO_NEVER",
...
mjtLogLevel = collections.namedtuple(
    "mjtLogLevel",
    ["mjLOG_DEBUG",
     "mjLOG_INFO",
     "mjLOG_WARNING",
...
mjtLogTopic = collections.namedtuple(
    "mjtLogTopic",
    ["mjTOPIC_NONE",
     "mjTOPIC_TIME_STP",
     "mjTOPIC_TIME_CMP",
